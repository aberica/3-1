...
public:
  ...
  mem_req_s* create_mem_req(addr_t address, int access_type); ///< moved from private to public for part3, 4
  std::vector<mem_req_s*> get_in_flight_reqs();               ///< made for part4
